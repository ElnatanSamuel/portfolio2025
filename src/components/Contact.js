  ...
  const socials = [
    {
      ...
      link: "https://github.com/ElnatanSamuel",
    },
    {
      name: "LINKEDIN",
      icon: (
      ...
      link: "https://www.linkedin.com/in/elnatansamuel999/",
    },
    {
      name: "MAIL",
      icon: (
      ...
      link: "mailto:elnatan23samuel@gmail.com",
    },
  ];
        ...
        <div className="flex justify-center gap-12 mt-12">
          {socials.map((social) => (
            <a
              ...
              className="relative font-mono text-base tracking-wider text-gray-500 hover:text-red-500 transition-colors group flex flex-col items-center"
            >
